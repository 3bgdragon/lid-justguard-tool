...
워프와 병용할 때는 워프툴도 `1.2.1-dev` 이상으로 갱신하세요. 구 워프툴은 새로운 가드 적용본을 인식하지 못합니다. **빌드 25244463의 M2G 적용본은 아직 지원하지 않습니다.** 아래 M2G 병용 안내는 빌드 25136512에 해당합니다. Node.js만 필요하며 게임 종료 후 실행하세요.
